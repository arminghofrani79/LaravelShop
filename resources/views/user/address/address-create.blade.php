...
<div class="flex flex-col gap-6 lg:col-span-4">
    ...
    <div class="flex flex-col items-center w-full gap-1 mb-2">
        <h1 class="text-2xl md:text-3xl font-bold text-gray-800">افزودن آدرس جدید</h1>
    </div>
        ...
        <div class="pb-4 border-b border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div class="flex flex-col gap-1.5">
                    ...
                    <input name="full_name" type="text" value="{{ old('full_name') }}" placeholder="علی محمدی"
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <input name="phone" type="text" value="{{ old('phone') }}" placeholder="0912 123 4567"
                        class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-right text-gray-700">
                    @error('phone')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
            ...
            <div class="mt-5 w-full md:w-1/2">
                <div class="flex flex-col gap-1.5">
                    ...
                    <input name="title" type="text" value="{{ old('title') }}" placeholder="مثلاً خانه یا دفتر"
                        class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-right text-gray-700">
                    @error('title')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
        ...
        <div class="pb-4 border-b border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <input name="province" type="text" value="{{ old('province') }}" placeholder="تهران"
                        class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-right text-gray-700">
                    @error('province')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <input name="city" type="text" value="{{ old('city') }}" placeholder="تهران"
                        class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-right text-gray-700">
                    @error('city')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <input name="postal_code" type="text" value="{{ old('postal_code') }}" placeholder="1589674711"
                        class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-right text-gray-700">
                    @error('postal_code')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
