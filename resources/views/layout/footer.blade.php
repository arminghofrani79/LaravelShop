<footer class="mt-12 bg-[#222831] text-[#EEEEEE] sm:mt-16">
    <div class="mx-auto max-w-7xl px-5 py-10 sm:px-6 sm:py-12">
        <div class="grid grid-cols-1 gap-10 text-center md:grid-cols-3 md:gap-12 md:text-right">
            ...
            <div class="flex flex-col">
                ...
                <img class="mt-5 h-auto w-52 max-w-full self-center object-contain md:self-start" src="{{ asset('images/logo/brand.webp') }}" alt="لوگوی فروشگاه Laravel Shop">
            </div>

            <div>
                <h4 class="mb-4 text-lg font-semibold">لینک‌های مفید</h4>
                <ul class="space-y-3 text-sm">
                    <li><a href="{{ route('index') }}" class="text-[#EEEEEE]/70 transition hover:text-[#00ADB5]">صفحه اصلی</a>
                    </li>
                    <li><a href="{{ route('products') }}" class="text-[#EEEEEE]/70 transition hover:text-[#00ADB5]">محصولات</a>
                    </li>
                    <li><a href="{{ route('articles') }}" class="text-[#EEEEEE]/70 transition hover:text-[#00ADB5]">مقالات</a>
                    </li>
                    <li><a href="{{ route('contact') }}" class="text-[#EEEEEE]/70 transition hover:text-[#00ADB5]">درباره ما</a>
                    </li>
                </ul>
            </div>
            <div>
