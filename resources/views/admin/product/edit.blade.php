@section('title', 'ویرایش محصول | LaravelShop')
    ...
    <form method="POST" action="{{ route('admin-update-product', ['product' => $product->id]) }}"
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="flex flex-col gap-2">
                ...
                <input value="{{ $product->discount }}" name="discount" type="text" placeholder="مثال: ۱۰"
                    class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white placeholder-gray-400">
            </div>
            <div>
                @error('discount')
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="flex flex-col gap-2">
                ...
                <input value="{{ $product->price }}" name="price" type="text" placeholder="مثال: ۲,۷۸۰,۰۰۰"
                    class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white placeholder-gray-400">
                <div>
                    @error('price')
                        <p class="text-sm text-red-500">{{ $message }}</p>
            ...
            <div class="flex flex-col gap-2">
                ...
                <input value="{{ $product->stock }}" name="stock" type="text" placeholder="مثال: ۱۳"
                    class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white placeholder-gray-400">
                <div>
                    @error('stock')
                        <p class="text-sm text-red-500">{{ $message }}</p>
            ...
            <div class="flex flex-col gap-2">
                ...
                <input value="{{ $product->image }}" name="image" type="file"
            ...
            <div class="flex flex-col gap-2">
                ...
                <div class="border border-gray-200 rounded-lg overflow-hidden flex flex-col">
                    ...
                    <textarea name="description" rows="4"
                        class="w-full p-3 text-sm border-0 focus:ring-0 resize-none min-h-[120px] placeholder-gray-400">
