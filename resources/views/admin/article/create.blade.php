@section('title', 'افزودن مقاله | LaravelShop')
...
<div class="lg:col-span-3 flex flex-col gap-6">
    ...
    <div class="w-full flex flex-col items-center gap-1 mb-2">
        <h1 class="text-2xl md:text-3xl font-bold text-gray-800">افزودن مقاله جدید</h1>
    </div>

    {{-- main --}}
    <form enctype="multipart/form-data" method="POST" action="{{ route('admin-store-article') }}"
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="flex flex-col gap-2">
                ...
                <input name="title" type="text" placeholder="عنوان مقاله را وارد کنید..."
