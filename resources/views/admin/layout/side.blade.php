...
<header class="bg-cover bg-center bg-no-repeat w-full h-30 flex items-center px-4 md:px-8"
    style="background-image: url('{{ asset('images/banners/backgroundadmin.png') }}');">
        ...
        <div class="lg:col-span-1 bg-white rounded-xl shadow-sm p-6 flex flex-col gap-4">
            ...
            <nav class="flex flex-col gap-2 mt-2">
                ...
                <a href="{{ route('admincategories') }}"
                    ...
                    <img class="w-4
                    h-4" src="{{ asset('images/icons/order.png') }}" alt="">
                ...
                <a href="{{ route('adminorders') }}"
                    ...
                    <img class="w-4
                    h-4" src="{{ asset('images/icons/buy.png') }}" alt="">
                    <span>سفارش ها</span>
                </a>
                <a href="{{ route('adminarticles') }}"
                    ...
                    <img class="w-4
                    h-4" src="{{ asset('images/icons/star2.png') }}"
                        alt="">
                    <span>مقالات</span>
                </a>
                <a href="{{ route('adminusers') }}"
                    ...
                    <img class="w-4
                    h-4" src="{{ asset('images/icons/support.png') }}"
                        alt="">
                    <span>کاربران</span>
                </a>
